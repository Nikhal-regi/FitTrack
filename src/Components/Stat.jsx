      ...
      <div className="relative bottom-[-2rem]">
        <div className="stats shadow">
          <div className="stat">
            ...
            <div className="stat-title text-white">Views</div>
          ...
          <div className="stat bg-blue-600">
            ...
            <div className="stat-title text-white">Likes</div>
          ...
          <div className="stat">
            ...
            <div className="stat-title text-white">New Posts</div>
            <div className="stat-value text-white">206</div>
            <div className="stat-desc text-white">↘︎ 22 (14%)</div>
          </div>
        </div>
      </div>
      <div className="relative">
        <ul className="timeline absolute top-[3rem] left-[-2.7rem]">
          <li>
            <div
